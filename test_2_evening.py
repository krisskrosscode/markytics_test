...
for data in main_df_1.to_dict('r'):
    ...
    url = "https://api-smartflo.tatateleservices.com/v1/broadcast/lead/214269"
    ...
    "field_10": str(data['Completed_Count']),
    "field_11": str(data['collection2_count']),
    "field_12": str(data['proposal2_count']),
    "field_13": str(data['retention2_count']),
    "field_14": str(data['wrong_number2_count']),
...
for data in main_df_2.to_dict('r'):
    ...
    url = "https://api-smartflo.tatateleservices.com/v1/broadcast/lead/214270"
...
for data in main_df_3.to_dict('r'):
    ...
    url = "https://api-smartflo.tatateleservices.com/v1/broadcast/lead/214271"
