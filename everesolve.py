...
# main_df = pd.merge(main_df,pending_task_df,left_on='U serID',right_on='assigned_to',how='left')
...
main_df = pd.merge(main_df,completed_task_df,left_on='UserID',right_on='assigned_to',how='right')
print(len(main_df))
...
stop_first_broadcast_url = "https://api-smartflo.tatateleservices.com/v1/broadcast/end/82205"
stop_second_broadcast_url = "https://api-smartflo.tatateleservices.com/v1/broadcast/end/82210"
stop_third_broadcast_url = "https://api-smartflo.tatateleservices.com/v1/broadcast/end/82211"
headers = {
    "accept": "application/json",
...
## to lead list 1 
for data in main_df_1.to_dict('r'):
    """ Updating lead list 1 """

    url = "https://api-smartflo.tatateleservices.com/v1/broadcast/lead/214374"
    ...
    "field_5": str(data['Completed_Count']),
...
for data in main_df_2.to_dict('r'):
    ...
    url = "https://api-smartflo.tatateleservices.com/v1/broadcast/lead/214413"
...
for data in main_df_3.to_dict('r'):
    ...
    url = "https://api-smartflo.tatateleservices.com/v1/broadcast/lead/214415"
