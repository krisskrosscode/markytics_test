...
def WN_Alternate_Ask(id,user_number,f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12):
    """Ask BRO If he has completed the task when alternate number is present """
    pass
